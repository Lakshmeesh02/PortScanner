...
print('-'*50)
print("PORT\tSERVICE\n")
services={100:"random", 22:"ssh", 25:"smtp", 80:"http", 135:"microsoft-rpc", 139:"netbios-ssn", 443:"https", 445:"microsoft-smb", 21:"ftp", 53:"dns"}     # map services for likely-to-be-open ports 
try:
    with open(f"results {target_ip}.txt", "w") as f:
        f.write(date_time)
        f.write('\n')
        f.write(f"Target hostname: {target_ip}\n")
